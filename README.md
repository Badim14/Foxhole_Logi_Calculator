...
```sql
CREATE DATABASE foxhole_logistics;
```
...
Запустите парсер для сбора данных с вики Foxhole:
...
- Загрузит данные с вики Foxhole
- Скачает изображения предметов и материалов
...
4. **Корзина**: Добавляйте предметы в корзину для планирования производства

### Интерфейс

- **Левая панель**: Список предметов с фильтрами
- **Правая панель**: Корзина с выбранными предметами
